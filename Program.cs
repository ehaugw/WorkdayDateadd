...
new DateTime(2004, 5, 24, 19, 3, 0).AddWorkingDays(workdayManager, 44);
new DateTime(2004, 5, 24, 18, 5, 0).AddWorkingDays(workdayManager, -5.5f);
new DateTime(2004, 5, 24, 18, 3, 0).AddWorkingDays(workdayManager, -6.7470217f);
